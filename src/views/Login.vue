...
<template>
  <div class="flex justify-center p-4">
    ...
    <div class="max-w-[577px] w-full mx-auto">
      ...
      <div class="flex flex-col w-full max-w-[577px] h-[520px] sm:h-[549px] p-0 bg-cover bg-center"   style="background-image: url('/images/popups/fenetre_login.png'); background-size: 100% 100%;">
      <h2 class="text-center mb-8 mt-[110px] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">Connexion</h2>
    ...
    <EyeSlashIcon v-else class="size-5 text-[#FFF2D0]" />
                    ...
                    <a 
            href="#" 
            class="block text-right text-sm mt-14 " 
            style="color:#FFF2D0;"
        ...
        class="text-red-600  text-center" style="margin-top:30px;"
        >
        ...
        <div class="space-y-4 flex flex-col items-center mt-50" style="margin-top:30px;">
        <button 
        ...
        <div class="text-center text-xl mt-8"> 
          <a href="/inscription" class="text-white">Créer un compte</a>
        </div>
      </div>
    </div>
  </div>
